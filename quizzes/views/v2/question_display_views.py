...
from quizzes.models import QuestionDisplaySet
...
class QuestionDisplaySetViewSet(viewsets.ViewSet):
    ...
    def create(self, request):
        ...
        try:
            validate_quiz_input(year_ids, type_ids, subject_id, topic_ids, display_set_name)
        ...
        question_display_set.topic.set(topic_ids)
